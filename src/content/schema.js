...
import founderSpeaking from "../assets//images/founder.jpeg";
...
export const COLLECTIONS = {
    ...
    defaults: [
      {
        ...
        details:
          "Each Ramadan, our team prepares and distributes food packages containing rice, maize, soya beans, vegetable oil, salt and seasoning to families identified by local community leaders. Distribution points are set up across multiple wards in Birnin-Kebbi to ensure accessibility. Recipients include widows, orphan-headed households and families living below the poverty line.",
        start_date: "2022-03-01",
        end_date: "Ongoing (annually)",
        beneficiaries: "350+ families per cycle",
      ...
      {
        tag: "Care",
        title: "Widows & Vulnerable Support",
        image_url: widowsKits,
  ...
  leaders: {
    ...
    defaults: [
      {
        name: "Aminatu Abdulkarim",
        role: "Founder & President",
        image_url: founderSpeaking,
        bio: "Visionary behind the foundation, leading every outreach with compassion and resolve.",
      },
      {
        name: "HRH, Emir of Argungu",
        role: "Grand Patron",
        image_url: patronEmir,
        bio: "Royal patron lending leadership, legitimacy and blessing to the foundation's mission.",
      },
      {
        name: "Administrative Secretary",
        role: "Operations & Coordination",
        image_url: adminSecretary,
        bio: "Coordinating programs, volunteers and day-to-day delivery across the communities we serve.",
      },
    ],
  },
    ...
    defaults: [
      {
        icon: "heart",
        title: "Compassion",
        text: "We lead every outreach with empathy and genuine care.",
      },
      {
        icon: "shield",
        title: "Dignity",
        text: "We protect the worth of every person we serve.",
      },
      {
        icon: "handshake",
        title: "Transparency",
        text: "Faithful, accountable stewardship of every gift.",
      },
      {
        icon: "sprout",
        title: "Self-Reliance",
        text: "We build lasting capacity, not just relief.",
      },
    ],
  },
    ...
    defaults: [
      {
        icon: "hand-heart",
        title: "Volunteer",
        text: "Join distributions, mentoring and outreach. Hands on the ground change everything.",
      },
      {
        icon: "handshake",
        title: "Partner With Us",
        text: "Corporate CSR, NGOs and institutions — let's scale impact together through partnership.",
      },
      {
        icon: "gift",
        title: "Donate Goods",
        text: "Food, clothing, books and materials. In-kind giving reaches families directly.",
      },
    ],
  },
  ...
  donate_tiers: {
    ...
    defaults: [
      ...
      {
        amount: "₦25,000",
        text: "equips a woman with a tailoring starter kit.",
      },
...
export const SETTINGS = {
  ...
  home_mission: {
    ...
    defaults: {
      statement:
        "A registered foundation born from compassion — serving widows, orphans and families in hardship with food, skills, education and dignity.",
      stat: "100%",
      stat_text:
        "of your intention reaches families in need — delivered with accountability and care.",
    },
  },
  ...
  about_intro: {
    ...
    defaults: {
      ...
      para1:
        "The Aminatu Abdulkarim Charity Foundation (RC No. 175798) is a registered non-profit serving the most vulnerable members of our community — widows, orphans, persons with disabilities and families living in hardship.",
      para2:
        "What began as quiet, personal giving has grown into an organised movement for dignity and self-reliance — meeting immediate needs while building long-term capacity in the people we serve.",
    },
  },
  ...
  about_vm: {
    ...
    defaults: {
      vision:
        "A society where every vulnerable person can live with dignity, hope, and the means to thrive.",
      mission:
        "To relieve poverty and empower the disadvantaged through food, education, healthcare and sustainable livelihoods.",
    },
  },
  ...
  impact_quote: {
    ...
    defaults: {
      ...
      quote:
        "This foundation reflects the very best of our values — caring for the orphan, the widow and the needy. It has my full support and blessing.",
  ...
  home_impact_band: {
    ...
    defaults: {
      ...
      stat1_num: "120+",
      stat1_text:
        "Women equipped with skills and starter kits to earn a living.",
      stat2_num: "200+",
